...
✅ Dynamic data handling using JavaScript DOM manipulation

## 🛠️Technologies Used

HTML5 – Structure of the application
CSS3 – Styling and layout
JavaScript – Form handling and CRUD operations

## screenshots
![Student-From](screenshot 1.png)
![Student-FROM](screenshot 2.png)
